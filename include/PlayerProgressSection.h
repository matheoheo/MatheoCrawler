...
class PlayerProgressSection : public IAboutSection
{
public:
	PlayerProgressSection(GameContext& gameContext, const sf::Vector2f& sectionPos, const sf::Vector2f& sectionSize);
